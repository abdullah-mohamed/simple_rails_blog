...
ActiveRecord::Schema.define(version: 2020_06_25_110152) do

  create_table "article_categories", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
